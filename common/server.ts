...
// NOTE(jimmylee):
// Some endpoints on https://api.internet.dev require server-side decryption. Without it,
// you won't be able to perform actions like password recovery or Google authentication.
// To enable these features, you'll need to set two environment variables with the correct
// values, and have an active partnership with us.
//
// When we built this open-source template for learning purposes, we aimed to make it fully
// open and accessible. However, since we are also running a service, certain restrictions
// are necessary. We appreciate your understanding.
//
// API_AES_KEY=
// API_IV_KEY=
