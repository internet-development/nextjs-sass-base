...
// NOTE(jimmylee):
// A modal component can either be a regular functional component, or one with a forwarded
// ref that can be supplied to `React.useImperativeHandle()` to customize properties of
// the modal that will be used by the modal manager (see `ModalRef`).
